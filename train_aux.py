        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if rank in [-1, 0]:
                ...
                if plots and ni < 10:
                    ...
                    Thread(target=plot_images, args=(imgs, targets, paths, f, None, 640, 16, nc), daemon=True).start()
                    # if tb_writer:
            ...
            if (not opt.nosave) or (final_epoch and not opt.evolve):  # if save
                ...
                try:
                    api.upload_file(
                            ...
                            path_in_repo="last_multilabels.pt",
                    ...
                    print('Can not save to huggingface')
                if best_fitness == fi:
                    ...
                    try:
                        api.upload_file(
                            ...
                            path_in_repo="best_multilabels.pt",
